                    ...
                    <div className="flex items-center gap-2">
                                    ...
                                    return (
                                        <DropdownMenuItem key={status.id} className="p-0">
                                            <form action={handleOnUpdateStatus} className="w-full p-1 ">
                                                ...
                                                <button name={status.label} className="w-full text-left">{status.label}</button>
                                            </form>
                                        </DropdownMenuItem>
                                    )
                                })}
                        ...
                        <Dialog>
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    <DropdownMenuItem>
                                        <Link href={`/invoices/${invoice.id}/payment`} className="flex items-center gap-2 w-full">
                                    ...
                                    <DropdownMenuItem>
                                        <DialogTrigger asChild>
                                            <button className="flex items-center gap-2 w-full hover:cursor-pointer">
                            ...
                            <DialogContent>
                                <DialogHeader className="items-center">
                                    ...
                                    <DialogFooter>
                                        <form action={deleteInvoiceAction} className="flex justify-center gap-4">
                                            <input type="hidden" name="id" value={invoice.id} />
                                            <Button className="flex items-center gap-2 w-full h-full hover:cursor-pointer" variant="destructive">
                                                <Trash2 className="w-4 h-auto" />
                                                Delete Invoice
                                            </Button>
                                        </form>
