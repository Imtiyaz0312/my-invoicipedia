...
export async function createAction(formData: FormData) {
    ...
    //         from: 'Invoicipedia <onboarding@resend.dev>',
    //         to: [email],
...
export default async function createPayment(formData: FormData) {
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        cancel_url: `${origin}/invoices/${id}/payment?status=canceled&sessionId={CHECKOUT_SESSION_ID}`,
    });
